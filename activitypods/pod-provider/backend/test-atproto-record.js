          ...
          return {
            results: {
              bindings: [{
                ...
                cid: { value: 'bafyreigb7diomga4pw4gbmqjdflxds5udhvouotvoy5tbdckvazsa7fl6i' },
                recordData: { value: JSON.stringify({ text: 'Hello, atproto world!', createdAt: '2025-07-31T22:40:42.124Z', langs: ['en'] }) },
                createdAt: { value: '2025-07-31T22:40:42.124Z' }
              }]
            }
          };
        } else {
...
async function testCreateRecord() {
  try {
    ...
    console.log('🧪 Test 1: Creating atproto record...');
